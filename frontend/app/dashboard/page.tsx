        ...
        <div className="grid lg:grid-cols-3 gap-6 animate-pulse">
          <div className="lg:col-span-2 space-y-6">
            <div className="grid sm:grid-cols-3 gap-4">
              <div className="h-28 rounded-2xl bg-zinc-200/50 dark:bg-white/5" />
              <div className="h-28 rounded-2xl bg-zinc-200/50 dark:bg-white/5" />
              <div className="h-28 rounded-2xl bg-zinc-200/50 dark:bg-white/5" />
            </div>
            <div className="h-96 rounded-2xl bg-zinc-200/50 dark:bg-white/5" />
          </div>
          <div className="space-y-6">
            <div className="h-96 rounded-2xl bg-zinc-200/50 dark:bg-white/5" />
            <div className="h-60 rounded-2xl bg-zinc-200/50 dark:bg-white/5" />
          </div>
        </div>
      ) : (
